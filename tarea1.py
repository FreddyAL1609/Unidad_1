...
def menu():
  ...
  while opcion != 11:
    ...
    print( BLUE+" Aquí puedes realizar cualquiera de las siguientes opciones: \n"+RESET)
    print(GREEN+"Opción 1: Leer archivo de disco duro, que carga 3 libros.")
    ...
    print("Opción 11: Para salir"+RESET)
